 ...
 */
public class FinalizeOrderController implements Initializable {
    @FXML
    ...
    public void ApproveVoucher(ActionEvent event)
    {
        ...
        reqdao.UpdatevoucherStatus(voucher.getVouchercode(), "OrderFinalized");
        ApprovalModal();
        GetVouchers();
    }
    ...
    public void GetVouchers()
    {
        ...
        RequisitionDataAccess reqdao = new RequisitionDataAccess();
        vlist = reqdao.GETvoucherlist("4AWard","OrderReceived");
    ...
    public void ApprovalModal()
    {
        try
        {
            FXMLLoader fxloader = new FXMLLoader(getClass().getResource("/com/afritrend/Ward/WardFinalizeModal.fxml"));
            Parent root = fxloader.load();            

            WardFinalizeModalController controller = fxloader.<WardFinalizeModalController>getController();                      
            controller.initData("VC68");             
