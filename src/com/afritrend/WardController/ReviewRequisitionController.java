...
import com.afritrend.PharmacyController.PharmacyReviewModalController;
 ...
 */
public class ReviewRequisitionController implements Initializable {
    @FXML
    ...
    public void ApproveVoucher(ActionEvent event)
    {
        ...
        reqdao.UpdatevoucherStatus(voucher.getVouchercode(), "PharmacyReviewed");
        GetVouchers();
    }
    ...
    public void GetVouchers()
    {
        ...
        RequisitionDataAccess reqdao = new RequisitionDataAccess();
        vlist = reqdao.GETvoucherlist("4AWard","PreparationApproved");
    ...
    public void ApprovalModal(String VoucherNumber)
    {
        try
        {
            FXMLLoader fxloader = new FXMLLoader(getClass().getResource("/com/afritrend/Pharmacy/PharmacyReviewModal.fxml"));
            Parent root = fxloader.load();
            
            PharmacyReviewModalController controller = fxloader.<PharmacyReviewModalController>getController();                      
